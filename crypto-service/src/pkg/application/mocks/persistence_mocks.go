...
// Source: src/pkg/application/application_contracts.go

// Package mock_application is a generated GoMock package.
package mock_application

import (
	application "genesis_test_case/src/pkg/application"
	models "genesis_test_case/src/pkg/domain/models"
	reflect "reflect"
...
func (m *MockMailingRepository) MultipleSending(message *models.EmailMessage, address []models.EmailAddress) ([]models.EmailAddress, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MultipleSending", message, address)
	ret0, _ := ret[0].([]models.EmailAddress)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// MultipleSending indicates an expected call of MultipleSending.
func (mr *MockMailingRepositoryMockRecorder) MultipleSending(message, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MultipleSending", reflect.TypeOf((*MockMailingRepository)(nil).MultipleSending), message, address)
}
...
func (m *MockEmailStorage) AddEmail(email models.EmailAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockEmailStorage) GetAllEmails() ([]models.EmailAddress, error) {
	m.ctrl.T.Helper()
